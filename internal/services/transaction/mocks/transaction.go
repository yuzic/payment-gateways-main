...
func (mr *MockTransactionServiceMockRecorder) Deposit(req any) *gomock.Call {
...
func (mr *MockTransactionServiceMockRecorder) UpdateStatus(txID, gatewayID, status any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTransactionServiceMockRecorder) Withdrawal(req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
